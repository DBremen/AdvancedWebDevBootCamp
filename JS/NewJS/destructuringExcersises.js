...
and a space and then the value of the last key. See if you can destructure this 
...
a default parameter which is a destructured object with 
the key of likesES2015 and value of true, 
and key of likesJavaScript and value of true. 

    If both the values of likesJavaScript and likesES2015 are true,
     the function should return the string 'The student likes JavaScript and ES2015'. 
...
function createStudent({ likesES2015 = true, likesJavaScript = true } = {}) {
  let prefix = "The student likes";
  if (likesES2015 && likesJavaScript) {
    console.log(prefix, "JavaScript and ES2015");
  } else if (likesJavaScript) {
    console.log(prefix, "JavaScript!");
  } else if (likesES2015) {
    console.log(prefix, "ES2015!");
  } else {
