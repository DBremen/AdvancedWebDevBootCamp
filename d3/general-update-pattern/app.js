...
add.on("click", () => {
  ...
  //update (elements that have data)
  var listItems = d3
    .select("#quotes")
    .selectAll("li")
    .data(quotes);
  ...
  listItems
    ...
    .merge(listItems); //merge new items and old
  //.style("color", "#5599ff"); //applies to updated and enter()
  add.remove(); //remove elements with no data
});
d3.select("#quotes")
